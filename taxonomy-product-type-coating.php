...
<section class="hero-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/build/assets/Banner for coatings products.jpg');">
    <h1> Discover our Coatings </h1>
...
<div class="content-area">
    <main>
        <div class="page-content">
            ...
            <?php else : ?>
                <p><?php _e('Sorry, no coatings found.', 'viper-theme'); ?></p>
            <?php endif; ?>
        </div>
    </main>
</div>
